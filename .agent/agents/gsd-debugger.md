...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/Users/systems/Desktop/Game/.gemini
                  → checks C:/Users/systems/Desktop/Game/.gemini/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/Users/systems/Desktop/Game/.gemini/get-shit-done
                  → writes to C:/Users/systems/Desktop/Game/.gemini/get-shit-done/hooks/
...
@C:/Users/systems/Desktop/Game/.gemini/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/Users/systems/Desktop/Game/.gemini/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "C:/Users/systems/Desktop/Game/.gemini/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "C:/Users/systems/Desktop/Game/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "C:/Users/systems/Desktop/Game/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
