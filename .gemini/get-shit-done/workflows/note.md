...
- **Global scope**: `C:/Users/systems/Desktop/Game/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/systems/Desktop/Game/.gemini/notes/`)
...
2. Glob `C:/Users/systems/Desktop/Game/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/systems/Desktop/Game/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/systems/Desktop/Game/.gemini/notes/` — works in any directory
